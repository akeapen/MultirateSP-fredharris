...
% Script written by fred harris of UCSD, Copyright 2021.
% bandwidth breater than spectral spacing
...
if flag2==1
    ...
    subplot(6,2,3)
    plt1=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,4)
    plt2=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,5)
    plt3=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5');
    grid
    axis([-0.3001 -0.10 0  1.1]) 
     ...
     subplot(6,2,6)
    plt4=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,7)
    plt5=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,8)
    plt6=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,9)
    plt7=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,10)
    plt8=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,11)
    plt9=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
    ...
    subplot(6,2,12)
    plt10=plot((-0.5:1/100:0.5-1/100)/5,zeros(1,100),'linewidth',1.5);
    grid
