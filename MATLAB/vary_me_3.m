% vary_me_3
% Animated display showing when an interpolator lowers the sample rate of a signal, it 
% appears that the signal BW is increasing relative to the sample rate. 
% The signal BW expands relative to fixed filter BW and spectral sections are rejected as they increase
% past bandwidth of filter.

% See "Fixed Length FIR Filters with Continuously Variable Bandwidth"
...
% Technology, 2009. Wireless VITAE 2009. Great Demo!
% Script file written by fred harris of UCSD, Copyright 2021.

h0=remez(639,[0 0.25 0.75 32]/32,{'myfrf',[1 1 0 0]},[1,200]);
h0=h0*64;
h1x=conv(h0,[1 0 -1]/2);
h1=h1x(2:641);
h2x=conv(h1,[1 0 -1]/2);
