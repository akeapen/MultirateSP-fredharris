...
using DSP, SignalAnalysis, FFTW, PlutoUI, Plots, LinearAlgebra, Distributed, LaTeXStrings
...
md"""#### Figure 2.25
Time and frequency description of four, fixed time interval, fixed sample rate ``=1``, with successively higher center frequencies ``f_0=0.1,0.2,0.4,`` and ``0.8``."""

# ╔═╡ 1f8a8e8d-5467-447b-b135-38c635f3b217
md""" 
Select ``f_0`` (_center frequency_) $(@bind f0 PlutoUI.Select([0.1, 0.2, 0.4, 0.8], default=0.1))
"""
...
md"""#### Figure 2.26
Time and frequency description of four, fixed time interval, fixed input frequency ``f_0=0.1``, with successively lower sample rates ``f_s=1,1/2,1/4,`` and ``1/8``."""
...
manifest_format = "2.0"
project_hash = "dce0d6a28cd0c9b56ed4760d819bd7c1662e685a"
...
git-tree-sha1 = "759d1a6ce5c0e2301624629d281f4e5308c63704"
